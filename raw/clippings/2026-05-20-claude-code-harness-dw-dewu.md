...
**痛点一：上下文失忆** — 口头约束（如 amount 单位为千元）在 [[Context Compact_上下文压缩|上下文压缩]] 后丢失，SQL 可能差 1000 倍。
...
核心结论：规范执行是人的短板、AI 的长板；业务判断是 AI 的短板、人的长板。[[Harness Engineering_Harness 工程|Harness 工程]] 目标是把执行层不稳定因素系统性消掉。
...
**Harness** = [[Claude Code_Claude Code|Claude Code]] 宿主运行框架（工具链容器），负责：
...
- [[Dewu_得物|得物]]
- [[Claude Code_Claude Code|Claude Code]]
- [[Danke_丹克|丹克]]
